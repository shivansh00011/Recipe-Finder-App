...
class IngredientItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      padding: EdgeInsets.only(top: h*.008, bottom: h*.008, left: h*.008,right: w*.08),
      ...
      child: Row(
        ...
        children: [
          ...
          Text('$food\n$quantity $measure', style: TextStyle(fontSize: w*.04, fontWeight: FontWeight.bold, letterSpacing: 1),)
